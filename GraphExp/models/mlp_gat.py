...
class Denoising_Unet(nn.Module):
    def __init__(self,
        ...
        self.mlp_middle = MlpBlock(num_hidden, num_hidden, num_hidden, norm=norm,
                                   activation=activation)  # num_hidden = 512
        ...
        for _ in range(1, num_layers):
            self.down_layers.append(
                GATConv(num_hidden, num_hidden // nhead, nhead, feat_drop,
    ...
    def forward(self, g, x_t, time_embed, filter_embed,
                position_embed):
